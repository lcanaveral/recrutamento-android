package com.lcanaveral.movile.traktapp.ui.behavior;
...
public class ImageBehavior extends CoordinatorLayout.Behavior {
    ...
    private final static String LOG_TAG = "ImageBehavior";
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        Log.i(LOG_TAG, maxScrollDistance+" " + expandedPercentageFactor);
